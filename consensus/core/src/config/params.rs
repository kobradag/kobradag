...
pub struct Params {
    ...
    /// The parameter for scaling inverse SQD value to mass units (unpublished KIP-0009)
...
pub const MAINNET_PARAMS: Params = Params {
    ...
    // This is technically a soft fork from the Go implementation since kobrad's consensus doesn't
