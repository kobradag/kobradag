...
pub fn cli() -> Command {
    ...
    let cmd = Command::new("kobrad")
        .about(format!("{} (rusty-kobrad) v{}", env!("CARGO_PKG_DESCRIPTION"), version()))
        ...
        .arg(
            Arg::new("rpclisten")
                ...
                .help("Interface:port to listen for gRPC connections (default port: 16110, testnet: 44448)."),
        )
        .arg(
...
/*
  ...
  -d, --loglevel=                           Logging level for all subsystems {trace, debug, info, warn, error,
      ...
      --minrelaytxfee=                      The minimum transaction fee in SQD/kB to be considered a non-zero fee.
                                            (default: 1e-05)
